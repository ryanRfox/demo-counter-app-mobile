...
def main() :
    ...
    approval_program_compiled = compile_program(algod_client, open("./1_approval.teal").read())

    # compile clear program to binary
    clear_state_program_compiled = compile_program(algod_client, open("./1_clear.teal").read())

    print("--------------------------------------------")
    print("Deploying Basic Counter application......")
