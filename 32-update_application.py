...
def main() :
    ...
    approval_program_compiled = compile_program(algod_client, open("./31_approval.teal").read())

    # compile clear program to binary
    clear_state_program_compiled = compile_program(algod_client, open("./31_clear.teal").read())
